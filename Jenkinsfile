node {  
  stage('SCM') {
    ...
    stage('SonarQube Analysis') {
          sh "/var/jenkins_home/sonar-scanner/sonar-scanner-3.3.0.1492-linux/bin/sonar-scanner -Dsonar.host.url=http://localhost:9000 -Dsonar.projectName=react-list -Dsonar.projectVersion=1.0 -Dsonar.projectKey=react-list:app -Dsonar.sources=. -Dsonar.projectBaseDir=/home/jenkins/workspace/sonar-pipeline"
    }
}
